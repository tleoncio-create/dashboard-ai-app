...
|---|---|
| Nome do projeto e produto | _ex.: Risk + Growth / TYJC_ |
| Quem é o fundador/stakeholder | _quem aprova e decide_ |
| Janela diária de decisão | _ex.: 7h–9h_ |
| Orçamento e tetos | _ex.: US$ 0–10/mês fixo; aposta limitada a R$ 8k + 3 sprints_ |
| Promessas públicas vigentes | _o que o site/produto já promete e não pode virar mentira_ |
| Constantes de marca | _grafia, preço, garantia — o que não muda sem DF_ |
| Documento de decisões | _caminho no repo, ex.: docs/<projeto>/decisoes-fundador.md_ |
| Papéis existentes | _quais agentes/pessoas existem: PO? SM? QA? squads?_ |
