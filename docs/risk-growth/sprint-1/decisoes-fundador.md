...
| DT-04 | Revalidação do QA: os 3 bloqueantes do veredito (BLQ-1 aguarda RG-02/RG-06; BLQ-2/BLQ-3 em correção), os casos adversariais do AC5, e a bateria do banner (bloqueio antes do aceite, recusa mantém Plausible, `sanitize()` com os dois sinks) | qa | D6, após correções |
