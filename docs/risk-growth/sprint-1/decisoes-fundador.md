...
| PF-05 | **Aprovar a redação da Privacy Policy §4/§5/§9** para acomodar o GA4 (DF-11) — é promessa pública, exige decisão do fundador, não do time | Ativação do GA4 (o Plausible segue independente) | Até D5 |
| PF-06 | Criar propriedade GA4 em analytics.google.com (grátis, ~10 min) com **Google Signals desligado** e **sem link com Google Ads**, e entregar o *Measurement ID* (`G-XXXXXXX`) | Ativação do GA4 | Até D5 |
