...
| DF-09 | 2026-08-06 (D2) | Domínio | **lessriskmoregrowth.com** — grafia confirmada com o fundador (corrigido o typo "groeth" da mensagem original). E-mail de contato: support@lessriskmoregrowth.com, já aplicado nas 18 ocorrências do site. |
...
| PF-02 | ~~Escolher domínio~~ **Definido: lessriskmoregrowth.com (DF-09)**. Resta: confirmar o **registro** do domínio e configurar o e-mail `support@` (encaminhamento serve) | US-01 (página no ar) + INT-3 (teste de e-mail) | Até D3 (sexta 07/08) |
