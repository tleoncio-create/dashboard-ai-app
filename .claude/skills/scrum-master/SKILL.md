...
|---|---|
| Cadência de sprint | _a definir com o PM/fundador (recomendação pendente: sprints de 7 dias)_ |
| Janela/horário do resumo diário | _a definir com o fundador_ |
| Caminho do board e do plano | `docs/sprint-N/board.md` (N = número da sprint) |
| Definition of Done acordada | _a definir. Mínimo já decidido pelo fluxo do projeto: código testado em HTML neste repo **antes** de qualquer export para o Lovable_ |
| Onde vivem os resumos | `docs/sprint-N/resumos/` |
| Quem são as squads e o QA | _a definir — hoje o time é PM + PO + SM (agentes), sem squad/QA dedicados_ |
