...
|---|---|
| Público-alvo / personas | Empreendedores (donos de pequenos negócios). Doc de personas: `docs/personas.md` — _a criar como primeira entrega do PO_ |
| Proposta de valor central | Um dashboard operacional que reúne, num só lugar, as ferramentas e acompanhamentos que o empreendedor precisa para operar o negócio no dia a dia. _Refinar com o fundador._ |
| Método de priorização adotado | _a definir com o PM/fundador (recomendação pendente: MoSCoW para o MVP, RICE depois)_ |
| Caminho do backlog | `docs/backlog.md` |
| Restrições vindas de decisões do stakeholder | Ver `docs/decisoes-fundador.md`. Já registrado: código nasce e é testado em HTML neste repo antes de ir ao Lovable; o MVP "4+1" está fora do escopo. |
| Quem exerce o QA | _a definir — hoje, verificação pelo próprio fluxo de teste em HTML antes do export_ |
